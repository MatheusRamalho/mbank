...
Uma landing page de um site para um banco digital. Uma releitura de sites atuais de bancos.
Projeto com finalidade apenas de estudo e pratica.
...
Você pode visualizar o deploy do projeto na vercel através [desse link](https://mbank-mat.vercel.app/).
...
```bash
git clone https://github.com/MatheusRamalho/mbank
```

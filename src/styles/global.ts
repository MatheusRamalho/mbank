...
export default createGlobalStyle`
    ...
    */
    ...
    @keyframes change-card {
        0%, 49% {
            background-image: url("../src/assets/svgs/card-front.svg");
            background-size: cover;
        }

        50%, 100% {
            background-image: url("../src/assets/svgs/card-back-inverted.svg");
            background-size: cover;
        }
    }
    ...
    .invite-bg {
        ...
        .svg-bg-invite svg {
            ...
            @media screen and (min-width: ${props => props.theme.containers.large}) {
                width: 100%;
            }
    ...
    #sect-the-best.the-best {
        .best {
            ...
            &::before {
                ...
                background-image: url('../src/assets/svgs/icon-entail.svg');

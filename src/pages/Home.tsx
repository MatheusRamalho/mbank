...
import brandFull from '../assets/svgs/brand-full.svg';
import heroBg from '../assets/svgs/bg-hero.svg';
import inviteBg from '../assets/svgs/bg-invite.svg';
...
import configIcon from '../assets/svgs/icon-config.svg';
import timeIcon from '../assets/svgs/icon-time.svg';
import contactlessIcon from '../assets/svgs/icon-contactless.svg';
import cashIcon from '../assets/svgs/icon-cash.svg';
import transferIcon from '../assets/svgs/icon-transfer.svg';
import phoneIcon from '../assets/svgs/icon-phone.svg';
import people1Svg from '../assets/svgs/people1.svg';
import people2Svg from '../assets/svgs/people2.svg';
import people3Svg from '../assets/svgs/people3.svg';
import digitalAccountSvg from '../assets/svgs/digital-account.svg';
import cardDoubleSvg from '../assets/svgs/card-double.svg';
        ...
        <>
            ...
            <div className="hero-wrapper">
                ...
                <Section classe="hero-sect py py--9" id="sect-hero" legend="Section de aterrissagem">
                    ...
                    <div className="hero-card flex flex--center flex-item flex-item--3 py py--7">
                        <ReactSVG
                            className="icon-card-hero" src={cardIcon}
                            role="img"
                            aria-label=""
                        />
                        <ReactSVG
                            className="icon-mobile-hero" src={mobileIcon}
                            role="img"
                            aria-label=""
                        />
                        <ReactSVG
                            className="icon-contactless-hero" src={contactlessIcon}
                            role="img"
                            aria-label=""
                        />
            ...
            <Section classe="people" id="sect-people" legend="Section para todos">
                ...
                <div className="flex-item flex-item--1 flex flex--column mx mx--2 my my--3">
                    <ReactSVG
                        id="people2" className="mb mb--4" src={people2Svg}
                        role="img"
                        aria-label=""
                    />
                    <ReactSVG
            ...
            <Section classe="digital-account" id="sect-digital-account" legend="Section conta digital">
                <div className="flex-item flex-item--1 flex flex--center mx mx--3">
                    <ReactSVG
                        className="account-svg" src={digitalAccountSvg}
                        role="img"
                        aria-label=""
                    />
                </div>
            ...
            <Section classe="credit-card" id="sect-credit-card" legend="Section tudo no app">
                ...
                <div className="flex-item flex-item--1 flex flex--center mx mx--3">
                    <ReactSVG
                        className="card-svg" src={cardDoubleSvg}
                        role="img"
                        aria-label=""
                    />
                </div>
            ...
            <Section classe="app-download" id="sect-app-download" legend="Section baixe o app e crie sua conta">
                ...
                <div className="flex-item flex-item--1 flex flex--center mx mx--3">
                    <ReactSVG
                        className="brand-download-svg" src={brandFull}
                        role="img"
                        aria-label=""
                    />
                </div>
            ...
            <div className="invite-wrapper">
                <div className="invite-bg">
                    <ReactSVG
                        className="svg-bg-invite" src={inviteBg}
                        role="img"
                        aria-label=""
                    />
                </div>
